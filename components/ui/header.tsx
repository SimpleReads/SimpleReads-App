        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="shrink-0 mr-4">
            ...
            <Link href="/" className="block" aria-label="Cruip">
              ...
              <img src="/images/simple reads.jpg" width={200} height={100}/>
            </Link>
          </div>

          <div>
            {/* Home button */}
            <Link href="/" className="btn-sm text-gray-900 bg-purple-600 hover:bg-purple-500 ml-3 "> Home </Link>
          </div>
          ...
          <nav className="hidden md:flex md:grow">
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              <li>
                <Link
                  href="/signin"
                  className="font-medium text-gray-900 hover:text-purple-500 px-4 py-3 flex items-center transition duration-150 ease-in-out"
                >
                  Sign in
                </Link>
              </li>
